...
ActiveRecord::Schema[7.0].define(version: 2023_06_15_224147) do
  ...
  create_table "user_relationships", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "direction"
    t.index ["friend_id"], name: "index_user_relationships_on_friend_id"
  ...
  add_foreign_key "user_relationships", "users", on_delete: :cascade
end
